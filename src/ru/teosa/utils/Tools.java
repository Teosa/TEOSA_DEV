...
//				result = String.format("%,d", Integer.parseInt(number.toString()));
	...
	/**
	 * Функция для вывода на консоль содержимого HashMap.<br>
	 * Формат вывода: KEY: <ключ>  VALUE:  <значение>
	...
	/**
	 * Функция для преобразования пустой строки в null.<br>
	 * Если длинна переданной в качесве параметра строки после удаления пробелов равна нулю, функция вернет null, 
	 * иначе - переданный параметр с удаленными слева и справа пробелами.
	 * @param value строка для проверки
	 * @return переданная строка без дополнительных пробелов или null
	 * */
